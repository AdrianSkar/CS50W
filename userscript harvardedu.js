// ==UserScript==
// @name        Don't rewrite URL at cs50.harvard.edu
// @namespace   Violentmonkey Scripts
// @match       https://cs50.harvard.edu/web/2020/*
// @grant       none
// @version     1.0
// @author      AdrianSkar
// @description 31/01/2021, 15:57:32
// @require https://cs50.harvard.edu/web/2020/assets/jquery/dist/jquery.min.js?1611091724
// ==/UserScript==

//////////////////* Harvard script without url rewriting *////////////////////
/// src file: cs50.harvard.edu/web/2020/assets/jekyll-theme-cs50.js?1611091724
...
$('[data-local]').each(function (index, element) {
	...
	if (local.length == 2) {
		...
		if (CS50.locale === 'en' && (
			...
			html = start.toLocaleString(opts) + ' â€“ ' + end.toLocaleString({
				hour: 'numeric',
				minute: 'numeric',
				timeZoneName: 'short'
			});
